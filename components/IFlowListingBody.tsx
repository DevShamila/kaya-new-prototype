...
const IFlowListingBody = () => {
  ...
  const totalPages = Math.max(
    1,
    Math.ceil(filteredIFlows.length / ITEMS_PER_PAGE),
  );
          ...
          <div className={styles.experienceWrapper}>
            <div className={styles.experience}>
              {mockIFlows.slice(0, 3).map((iflow) => (
                <div key={iflow.id} className={`${styles.flatCard} p-0!`}>
                  <div className="p-4">
                    <div
                      className={
                    ...
                    <div
                      className={`${styles.flatCardMeta} w-full flex items-center justify-between mt-4`}
                    >
                      <span>
                        <b className="text-[#181d27] font-semibold">
                          {iflow.agents}
                        </b>{" "}
                        Agents
                      </span>
                      <span>
                        Last modified:{" "}
                        <b className="text-[#181d27] font-medium">
                          {iflow.lastModified}
                        </b>
                      </span>
                    </div>
                  </div>
                  <div className={`${styles.flatCardFooter} p-4!`}>
                    <button
                ...
                <div key={iflow.id} className={`${styles.flatCard} p-0!`}>
                  <div className="p-4">
                    ...
                    <div className="space-y-1">
                      <div className="text-base font-semibold text-[#181d27] leading-6 mt-[10px]">
                        {iflow.name}
                      </div>
                      <div className="text-sm text-[#414651] leading-5">
                        This workflow handles {iflow.name.toLowerCase()} tasks.
